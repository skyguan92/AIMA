...
当前共 78 个 MCP 工具覆盖所有功能领域 (Hardware 2 + Model 6 + Engine 6 + Deploy 7 + Knowledge 23 + Benchmark 4 + Stack 3 + Catalog 2 + System 2 + Discovery 1 + Agent 8 + Fleet 4 + Shell 1 + Tuning 4 + Device 2 + App 3)。
