...
| Ready Combos | 10 | model×engine pairs eligible for new tasks |
| Blocked Combos | 119 | pairs known to fail (format/type/VRAM/prior error) |
| Already Explored Combos | 51 | pairs with successful or failed history |
| Pending Work Items | 10 | durable obligations on ready combos |
