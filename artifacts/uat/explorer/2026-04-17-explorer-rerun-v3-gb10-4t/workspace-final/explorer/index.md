...
| Ready Combos | 2 | model×engine pairs eligible for new tasks |
| Blocked Combos | 104 | pairs known to fail (format/type/VRAM/prior error) |
| Already Explored Combos | 74 | pairs with successful or failed history |
| Pending Work Items | 2 | durable obligations on ready combos |
