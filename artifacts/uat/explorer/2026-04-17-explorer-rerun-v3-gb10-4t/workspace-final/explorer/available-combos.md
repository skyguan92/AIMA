...
| GLM-4.5-Air-nvfp4 | glm-asr-fastapi | container | qujing-glm-asr-nano:latest | recently cancelled |
| GLM-4.5-Air-nvfp4 | qwen-tts-fastapi | container | qujing-qwen3-tts-real:latest | recently cancelled |
| GLM-4.5-Air-nvfp4 | sglang | container | lmsysorg/sglang:dev-arm64-cu13 | recently cancelled |
| GLM-4.5-Air-nvfp4 | vllm | container | qujing/vllm-gemma4-gb10:0.19.0-torchmoe2 | recently cancelled |
| GLM-4.5-Air-nvfp4 | vllm-nightly | docker | vllm/vllm-openai:qwen3_5-cu130 | recently cancelled |
| GLM-4.5-Air-nvfp4 | z-image-diffusers | container | qujing-z-image:latest | recently cancelled |
...
| GLM-4.7-Flash-NVFP4 | sglang | docker | lmsysorg/sglang:dev-arm64-cu13 | Repeated endpoint readiness timeouts on Blackwell; likely kernel/loader crash |
...
| MiniCPM-o-4_5 | sglang | docker | lmsysorg/sglang:dev-arm64-cu13 | Repeated endpoint readiness timeouts on Blackwell; likely kernel/loader crash |
