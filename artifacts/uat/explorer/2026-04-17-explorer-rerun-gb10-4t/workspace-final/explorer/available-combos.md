...
|-------|--------|---------|-----------------|--------|
| GLM-4.1V-9B-Thinking | vllm-nightly | docker | vllm/vllm-openai:qwen3_5-cu130 | pending: tune |
| GLM-4.1V-9B-Thinking-FP4 | vllm-nightly | docker | vllm/vllm-openai:qwen3_5-cu130 | pending: tune |
| GLM-4.5-Air-nvfp4 | sglang | docker | lmsysorg/sglang:dev-arm64-cu13 | pending: validate_baseline |
| GLM-4.5-Air-nvfp4 | vllm | docker | qujing/vllm-gemma4-gb10:0.19.0-torchmoe2 | pending: validate_baseline |
| GLM-4.5-Air-nvfp4 | vllm-nightly | docker | vllm/vllm-openai:qwen3_5-cu130 | pending: tune |
| GLM-4.7-Flash-NVFP4 | sglang | docker | lmsysorg/sglang:dev-arm64-cu13 | pending: validate_baseline |
| GLM-4.7-Flash-NVFP4 | vllm | docker | qujing/vllm-gemma4-gb10:0.19.0-torchmoe2 | pending: validate_baseline |
| Qwen2.5-Coder-7B-Instruct | vllm-nightly | docker | vllm/vllm-openai:qwen3_5-cu130 | pending: tune |
| MiniCPM-o-4_5 | sglang | docker | lmsysorg/sglang:dev-arm64-cu13 | pending: validate_baseline |
| MiniCPM-o-4_5 | vllm | docker | qujing/vllm-gemma4-gb10:0.19.0-torchmoe2 | pending: validate_baseline |
...
| GLM-4.1V-9B-Thinking | vllm | container | qujing/vllm-gemma4-gb10:0.19.0-torchmoe2 | recently failed |
...
| SenseVoiceSmall | glm-asr-fastapi | container | qujing-glm-asr-nano:latest | recently failed |
...
| gemma-4-26B-A4B-it | vllm-nightly | container | vllm/vllm-openai:qwen3_5-cu130 | recently failed |
...
| GLM-4.1V-9B-Thinking | glm-asr-fastapi | container | qujing-glm-asr-nano:latest | modality mismatch: engine glm-asr-fastapi does not support model type "llm" (supported: [asr]) |
| GLM-4.1V-9B-Thinking | qwen-tts-fastapi | container | qujing-qwen3-tts-real:latest | modality mismatch: engine qwen-tts-fastapi does not support model type "llm" (supported: [tts]) |
| GLM-4.1V-9B-Thinking | sglang | container | lmsysorg/sglang:dev-arm64-cu13 | resolve config: no variant of model "GLM-4.1V-9B-Thinking" for engine "sglang" gpu_arch "Blackwell" (vram 122570 MiB) |
| GLM-4.1V-9B-Thinking | z-image-diffusers | container | qujing-z-image:latest | modality mismatch: engine z-image-diffusers does not support model type "llm" (supported: [image_gen]) |
| GLM-4.1V-9B-Thinking-FP4 | glm-asr-fastapi | container | qujing-glm-asr-nano:latest | modality mismatch: engine glm-asr-fastapi does not support model type "llm" (supported: [asr]) |
| GLM-4.1V-9B-Thinking-FP4 | qwen-tts-fastapi | container | qujing-qwen3-tts-real:latest | modality mismatch: engine qwen-tts-fastapi does not support model type "llm" (supported: [tts]) |
| GLM-4.1V-9B-Thinking-FP4 | sglang | container | lmsysorg/sglang:dev-arm64-cu13 | resolve config: no variant of model "GLM-4.1V-9B-Thinking-FP4" for engine "sglang" gpu_arch "Blackwell" (vram 122570 MiB) |
| GLM-4.1V-9B-Thinking-FP4 | vllm | container | qujing/vllm-gemma4-gb10:0.19.0-torchmoe2 | resolve config: no variant of model "GLM-4.1V-9B-Thinking-FP4" for engine "vllm" gpu_arch "Blackwell" (vram 122570 MiB) |
| GLM-4.1V-9B-Thinking-FP4 | z-image-diffusers | container | qujing-z-image:latest | modality mismatch: engine z-image-diffusers does not support model type "llm" (supported: [image_gen]) |
...
| Qwen2.5-Coder-7B-Instruct | glm-asr-fastapi | container | qujing-glm-asr-nano:latest | modality mismatch: engine glm-asr-fastapi does not support model type "llm" (supported: [asr]) |
| Qwen2.5-Coder-7B-Instruct | qwen-tts-fastapi | container | qujing-qwen3-tts-real:latest | modality mismatch: engine qwen-tts-fastapi does not support model type "llm" (supported: [tts]) |
| Qwen2.5-Coder-7B-Instruct | sglang | container | lmsysorg/sglang:dev-arm64-cu13 | resolve config: no variant of model "Qwen2.5-Coder-7B-Instruct" for engine "sglang" gpu_arch "Blackwell" (vram 122570 MiB) |
| Qwen2.5-Coder-7B-Instruct | vllm | container | qujing/vllm-gemma4-gb10:0.19.0-torchmoe2 | resolve config: no variant of model "Qwen2.5-Coder-7B-Instruct" for engine "vllm" gpu_arch "Blackwell" (vram 122570 MiB) |
| Qwen2.5-Coder-7B-Instruct | z-image-diffusers | container | qujing-z-image:latest | modality mismatch: engine z-image-diffusers does not support model type "llm" (supported: [image_gen]) |
