...
| GLM-4.5-Air-nvfp4 | safetensors | llm | 57.68 | — | ✅ |
...
| vllm | container | qujing/vllm-gemma4-gb10:0.19.0-torchmoe2 | flash_attention | port, served_model_name, gpu_memory_utilization, max_model_len |
| vllm-nightly | container | vllm/vllm-openai:qwen3_5-cu130 | triton_attention | gpu_memory_utilization, max_model_len, enable_chunked_prefill, port, served_model_name |
