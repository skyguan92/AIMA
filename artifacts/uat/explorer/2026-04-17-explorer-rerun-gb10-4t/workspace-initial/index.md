...
_Generated: 2026-04-17 01:19:40_
...
| Ready Combos | 11 | model×engine pairs eligible for new tasks |
| Blocked Combos | 124 | pairs known to fail (format/type/VRAM/prior error) |
| Already Explored Combos | 45 | pairs with successful or failed history |
| Pending Work Items | 11 | durable obligations on ready combos |
