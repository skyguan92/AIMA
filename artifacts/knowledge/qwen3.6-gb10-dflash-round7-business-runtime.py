...
OUT = Path("/tmp/qwen3.6-gb10-dflash-round7-business-runtime.json")

CASES = [
    {"label": "business_eager_block1280", "enforce_eager": True},
    {"label": "business_noneager_block1280", "enforce_eager": False},
]
...
def bench(case_label, inp, prompt):
    res = run(
        [
            ...
            prompt,
            "--notes",
            f"round7 {case_label} {inp//1024}k 1k business",
        ],
        timeout=2400,
    )
