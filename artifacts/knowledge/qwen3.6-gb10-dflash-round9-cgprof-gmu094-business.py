...
OUT = Path("/tmp/qwen3.6-gb10-dflash-round9-cgprof-gmu094-business.json")
...
def bench(inp, prompt):
    res = run(
        [
            ...
            prompt,
            "--notes",
            f"round9 business_noneager_cgprof_gmu094 {inp//1024}k 1k business",
        ],
        timeout=2600,
    )
...
def main():
    ...
    result = {
        "label": "business_noneager_cgprof_gmu094",
